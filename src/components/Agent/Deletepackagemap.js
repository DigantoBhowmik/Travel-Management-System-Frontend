...
const Deletepackagemap = (props) => {
    ...
    const handleSubmit=(e)=>{
        e.preventDefault();
        console.log(update)
            axios.delete(`http://127.0.0.1:8000/api/packagedelete/${id}`,update)
            .then(resp=>{
                if(!resp.data){
                    console.log('error')
                }
        ...
        <div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <input type="submit" name="submit" value="Delete Package" className="btn btn-primary login_button"/>
          </form>  
        </div>
        </div>
    );
...
export default Deletepackagemap;